...
clamping, convolutions, or matrix inversions.

For every tensor value $T$ in the IR, the analysis will keep a sparsity vector $a(T)$,
which will consist of a single bitmap per dimension, representing the current sparsity
...
for example by shrinking the iteration space of loops or extracting and 
reinserting slices.
