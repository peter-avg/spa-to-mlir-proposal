\begin{abstract}
    ...
    including machine learning workloads and stencil solvers for partial
    differential equations (PDEs). Exploiting this sparsity is critical for reducing
    memory footprint and avoiding redundant computation.
