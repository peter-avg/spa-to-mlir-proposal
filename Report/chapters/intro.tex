...
and output tensors are guaranteed to be relevant to the computation,
when executing tensor operations.
...
Tensor Algebra Compiler (TACO) \cite{taco2017} \footnote{\url{https://github.com/lac-dcc/adlet}}.
This proposes a barrier of adoption for SPA in other compilers and DSLs,
as it requires significant engineering effort to implement the analysis as a separate
pass. Additionally, SPA is currently only implemented for a small subset of
tensor operations, which limits its applicability to a wider range of applications.
