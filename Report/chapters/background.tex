...
where a single bit is set to 0 if the corresponding slice is irrelevant to
the final result of the computation, and 1 otherwise.
...
and addition. Currently, only the aforementioned semirings are supported in SPA 
but it is possible to extend to more.
